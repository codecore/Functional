...
namespace Functional.Implementation {
    public static partial class F {
        ...
        [Coverage(TestCoverage.F_add_int)]
        public static int add_int(IEnumerable<int> seq) { return F<int>.reduce(seq, F.add_int); }
        /// <summary>add an int with a sequence of ints</summary><returns>sum of all the ints</returns>
        [Coverage(TestCoverage.F_add_int)]
        public static int add_int(int t, IEnumerable<int> seq) { return F<int>.reduce(seq, F.add_int, t); }
        /// <summary>add a sequence of ints with an int</summary><returns>sum of all the ints</returns>
        [Coverage(TestCoverage.F_add_int)]
        public static int add_int(IEnumerable<int> seq, int t) { return F<int>.reduce(seq, F.add_int, t); }

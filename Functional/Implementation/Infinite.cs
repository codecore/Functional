...
namespace Functional.Implementation {
    public static partial class F {
        ...
        [Coverage(TestCoverage.F_infinite_bool)]
        public static Func<bool, IEnumerable<bool>> infinite_bool = (b) => F<bool>.forever(b);
        /// <summary>Takes a bool and returns an infinite sequence of that bool</summary><returns>an infinite sequence of bools</returns>
        [Coverage(TestCoverage.F_infinite_bool_toggle)]
        public static Func<bool, IEnumerable<bool>> infinite_bool_toggle = (b) => F<bool>.forever((x)=>!x, b);
        ...
        public static Func<int,IEnumerable<int>> infinite_range_start_inc = (start) => F<int>.forever((x)=>x+1,start);

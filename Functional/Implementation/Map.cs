...
namespace Functional.Implementation {
    public static partial class F<T>   {
        ...
        [Coverage(TestCoverage.F_T_map_U)]
        ...
        [Coverage(TestCoverage.F_T_map_U_2_List)]
        ...
        [Coverage(TestCoverage.F_T_map_U_3_List)]
